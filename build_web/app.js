...
// include: C:\Users\kevin\AppData\Local\Temp\tmplfot31t4.js
...
Module['FS_createPath']("/assets", "images", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/images/ASSEMBLY_BODY.png", "start": 0, "end": 79533}, {"filename": "/assets/images/BODY_PAINTED.png", "start": 79533, "end": 87168}, {"filename": "/assets/images/BODY_RAW.png", "start": 87168, "end": 190786}, {"filename": "/assets/images/BRIDGE.png", "start": 190786, "end": 228083}, {"filename": "/assets/images/Body Assembler.png", "start": 228083, "end": 386911}, {"filename": "/assets/images/Body Cutter.png", "start": 386911, "end": 549671}, {"filename": "/assets/images/Bridge Spawner.png", "start": 549671, "end": 710764}, {"filename": "/assets/images/ELEC.png", "start": 710764, "end": 849571}, {"filename": "/assets/images/Elec Part Collector.png", "start": 849571, "end": 953574}, {"filename": "/assets/images/GUITAR.png", "start": 953574, "end": 1047560}, {"filename": "/assets/images/HEAD_RAW.png", "start": 1047560, "end": 1079182}, {"filename": "/assets/images/Head Cutter.png", "start": 1079182, "end": 1242670}, {"filename": "/assets/images/NECK_RAW.png", "start": 1242670, "end": 1270914}, {"filename": "/assets/images/Neck Cutter.png", "start": 1270914, "end": 1423135}, {"filename": "/assets/images/PICKUP.png", "start": 1423135, "end": 1437778}, {"filename": "/assets/images/Packager.png", "start": 1437778, "end": 1587135}, {"filename": "/assets/images/Painter.png", "start": 1587135, "end": 1748104}, {"filename": "/assets/images/Part Assembler.png", "start": 1748104, "end": 1917123}, {"filename": "/assets/images/Pickup Spawner.png", "start": 1917123, "end": 2079685}, {"filename": "/assets/images/TECHNICIAN.png", "start": 2079685, "end": 4778742}, {"filename": "/assets/images/WOOD_BODY.png", "start": 4778742, "end": 4782129}, {"filename": "/assets/images/Wood Spawner.png", "start": 4782129, "end": 4945105}], "remote_package_size": 4945105});

  })();

// end include: C:\Users\kevin\AppData\Local\Temp\tmplfot31t4.js
// include: C:\Users\kevin\AppData\Local\Temp\tmpe5irx_2d.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\kevin\AppData\Local\Temp\tmpe5irx_2d.js
// include: C:\Users\kevin\AppData\Local\Temp\tmp34beeym6.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\kevin\AppData\Local\Temp\tmp34beeym6.js
...
var ASM_CONSTS = {
  231564: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 231779: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 231926: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 232160: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL2.audioContext); } } } return SDL2.audioContext === undefined ? -1 : 0; },  
 232712: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
 232780: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearInterval(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; SDL2.capture.silenceBuffer = undefined } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vp', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vp', $2, [$3]); }; SDL2.capture.silenceTimer = setInterval(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); } },  
